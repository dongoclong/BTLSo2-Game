...
public class BombermanGame extends Application {
    ...
    public static int startSpeed = 2; // chỉ số speed đạt dc khi ăn speeditem
    public static int startFlame = 1; // chỉ số bán kinh flame tăng thêm khi ăn flameitem
    public static int startDeno = 1; // chỉ số bán kinh flame tăng thêm khi ăn Deitem
    ...
    public static int cout = 3; // số mạng
